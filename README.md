...
flowchart LR
    ...
    %% 스타일
    classDef topMenu fill:#fce4ec,stroke:#c2185b,stroke-width:2px,rx:10,ry:10;
    classDef subMenu fill:#e1f5fe,stroke:#0288d1,stroke-width:1px,rx:6,ry:6,font-size:12px;
    class A,L,M,B,C,D,E,F topMenu;
...
flowchart LR
    ...
    %% 스타일
    classDef topMenu fill:#f9f,stroke:#333,stroke-width:2px;
    classDef subMenu fill:#bbf,stroke:#333,stroke-width:1px;
    class A topMenu;
